...
import traffic_fx.StopLight;
import traffic_fx.Road;
import traffic_fx.LightGui;
...
public class TrafficSim {
    ...
    GraphicsContext gc;
    Canvas canvas;
    AnchorPane dataAnchorPane, lightGUIAnchorPane;
    HBox buttonHBox, inputHBox;
    TextArea dataTextArea;
    GridPane guiGridPane;
    int resetFrame = 0, frameCounter = 0, fps = 15;
    AnimationTimer animationTimer;
    TrafficFXMLController guiController;
    


    public TrafficSim(int ww, int hh, TrafficFXMLController controller) {
        w = ww;
        h = hh;
    ...
    public void createGui(){
        ...
        inputHBox = guiController.inputHBox;
        ...
        inputHBox.getChildren().addAll(streetsLabel, streets, avenuesLabel, avenues);
        ...
        lightGUIAnchorPane = guiController.lightGUIAnchorPane;
        lightGUIAnchorPane.getChildren().add(guiGridPane);
        
        dataTextArea = guiController.dataTextArea;
